...
if __name__ == "__main__":
    from smg.utils.preprocessor import Preprocessor
    from smg.utils.methods import RadiativesFactory
    import sys
    ...
    from smg.utils.methods import SunSat
    ...
    for group in groups:
        ...
        data = RadiativesFactory(sunsat=SunSat()).rho_atm(afgl)
